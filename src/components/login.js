...
const Login = (props) => {
    ...
    const SignIn = async() => {
        if(email === '' && password === '') {
            ...
            props.navigation.navigate('DrawerRouting')
                ...
                <View>
                    <View style={{marginHorizontal:'5%', marginVertical:'3%'}}>
                        ...
                        value= {email}
                            ...
                            style={{backgroundColor:'#fff',marginVertical:5, elevation:10,borderRadius:8, borderBottomColor:'rgba(0, 0, 0, 0.25)', borderBottomWidth:2, shadowOpacity:20, shadowOffset:'10'}} />
